...
INSERT INTO CI_MIDDLEWAY..ticketoffice_gateway_result (id_ticketoffice_user, id_ticketoffice_shoppingcart, transactionKey, id_gateway,bin)
SELECT TOP 1 topp.id_ticketoffice_user, tosc.id, topp.pinpad_transactionId, 6,@bin
