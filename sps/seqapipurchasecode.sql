CREATE PROCEDURE dbo.seqapipurchasecode (@id BIGINT)
...
--2
SET @helper='8'
SELECT @helper = letra FROM #array where indice = @day+ABS(CHECKSUM(NEWID()) % 31)
SELECT @codVenda=@codVenda+@helper
...
--4
SET @helper='6'
SELECT @helper = letra FROM #array where indice = @minuteFull+ABS(CHECKSUM(NEWID()) % 31)
SELECT @codVenda=@codVenda+@helper

--5
SET @helper='8'
SELECT @helper = letra FROM #array where indice = @milesecondsWith1_1+ABS(CHECKSUM(NEWID()) % 31)
SELECT @codVenda=@codVenda+@helper

--6
SET @helper='5'
SELECT @helper = letra FROM #array where indice = @milesecondsWith1_2+ABS(CHECKSUM(NEWID()) % 31)
SELECT @codVenda=@codVenda+@helper
...
--8
SET @helper='3'
SELECT @helper = letra FROM #array where indice = @secondsFull+ABS(CHECKSUM(NEWID()) % 31)
SELECT @codVenda=@codVenda+@helper
...
--12
SET @helper='8'
SELECT @helper = letra FROM #array where indice = @id_1+ABS(CHECKSUM(NEWID()) % 31)
SELECT @codVenda=@codVenda+@helper

--13
SET @helper='8'
SELECT @helper = letra FROM #array where indice = @id_2+ABS(CHECKSUM(NEWID()) % 31)
SELECT @codVenda=@codVenda+@helper

--14
SET @helper='8'
SELECT @helper = letra FROM #array where indice = @id_3+ABS(CHECKSUM(NEWID()) % 31)
SELECT @codVenda=@codVenda+@helper

--15
SET @helper='8'
SELECT @helper = letra FROM #array where indice = @id_4+ABS(CHECKSUM(NEWID()) % 31)
SELECT @codVenda=@codVenda+@helper
