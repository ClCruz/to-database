...
CREATE TABLE #result (id INT, [name] VARCHAR(1000), document VARCHAR(1000), email VARCHAR(1000), indice INT, CodApresentacao INT, seat VARCHAR(1000), codSala INT, room VARCHAR(1000), [date] datetime, hour varchar(10))
...
INSERT INTO #result (id, [name], document, email, indice, CodApresentacao, seat, codSala, room, [date], hour)
SELECT DISTINCT
c.id_cliente
